...
//const logs = new Logs({
 //   config: Configs.logs.config,
 //   childConfig: Configs.logs.childConfig,
 //   bgBlur: Configs.logs.bgBlur,
  //  bgFocus: Configs.logs.bgFocus
//});
    ...
    queue.stream.on('play', (song) => {
     ...
     //   process.stdin.on('readable', () => {
      ...
      //  while ((chunk = process.stdin.read()) !== null) {
        ...
        //   logs.createBoxChildAndAppend(chunk);
     //   }
   // });
        view.render();
    });
