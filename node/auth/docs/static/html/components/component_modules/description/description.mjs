...
export default (...args)=>{
    return  new Promise(async (resolve, reject) => {
        ...
        function isNotEmptyActions(actions, object) {
                let out = false
                if(isEmpty(actions)){
                    colorlog(object.description.console, `${emoji('cowboy_hat_face')}description.mjs${emoji('cowboy_hat_face')} для этого отношения нет никаких действий` ,object.description.color,object.description.substrate, `${object.description.relation}`)
                    object.description.property = {
                        end: true,
