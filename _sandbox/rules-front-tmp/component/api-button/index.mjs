...
const INDEX = class extends HTMLElement {
    ...
    connectedCallback() {
        onload(this)
            .then(async (self) => {
                const { actions } = await import(`/component/${COMPONENT}/actions/index.mjs`)
                let { controller } = await import(`/component/${COMPONENT}/controller/index.mjs`)
