...
export let pixelToVMIN = function (value) {
  // console.log('pixelToVW', value, `=>`, `${(100 * value) / window.innerWidth}vw`)
  const data = window.innerWidth > window.innerHeight ? window.innerHeight : window.innerWidth
  return ((100 * value) / data)
}

export let ratio = function (value) {
  // console.log('pixelToVW', value, `=>`, `${(100 * value) / window.innerWidth}vw`)
  // const data = window.innerWidth > window.innerHeight ? window.innerHeight : window.innerWidth
