import modules from '/static/html/components/api-substrate/external/index.mjs'

customElements.define('api-substrate',
    class extends HTMLElement {
        ...
        disconnectedCallback() {
            console.log(`     🔴 component ${this.tagName} disconnected`)
        }
    })