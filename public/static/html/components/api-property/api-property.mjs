// import api from '/static/html/components/api-relation/external/index.mjs'
import modules from '/static/html/components/api-property/external/index.mjs'
customElements.define('api-property',
  class extends HTMLElement {
      ...
      constructor () {
          ...
          function scriptTemplate (obj, parent) {
              return new Promise(function (resolve, reject) {
                  let verify = false
                  const scripts = parent['this'].querySelectorAll('script')

                  for(let i = 0; i < scripts.length; ++i) {
                      if(scripts[i].src.endsWith(`${obj.tagName.toLowerCase()}.mjs`)) {
                          verify = true
                      }
                  }
            ...
            .then((obj) => {
                template(obj)
                  .then((obj) => {
                      style(obj)
                        .then((obj) => {
                            modules.init(true,0,'red',obj,'waves-game-card')
                        })
                  })
            })
      }
