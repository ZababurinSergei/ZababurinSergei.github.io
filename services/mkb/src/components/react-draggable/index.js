...
var Rnd = /** @class */ (function (_super) {
    ...
    function Rnd(props) {
        ...
        _this.originalPosition = { x: 0, y: 200 };
    ...
    Rnd.prototype.componentDidMount = function () {
        ...
        // var yOffset = this.getOffsetHeight() - this.props.default.height - parentRect.top
        var yOffset = window.innerHeight - selfRect.top - this.props.default.height
        // y: yOffset < 0 ? top + yOffset - 12 : y - top
